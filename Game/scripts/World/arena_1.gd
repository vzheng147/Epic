...
var back := "res://scenes/World/floor_1.tscn"
var destination := "res://scenes/World/floor_2.tscn"
...
func boss_death():
	...
	door_instance.global_position = Vector2(185, 194)
	add_child(door_instance)
	var chest_instance = chest.instantiate()
	chest_instance.drop = drop
	chest_instance.global_position = Vector2(125, 185)
	Global.player_position = Vector2(0, 0)
	add_child(chest_instance)
	
	
func _on_exit_pressed():
	Global.player_position = Vector2(-1560, 5)
